...
<div class="container" style="margin-top:100px; margin-bottom:100px;">
	...
	<h4 class="card-title">${readReportDTO.postNo}번 게시글 신고내역</h4> 
		<a href='${root }board/read?postNo=${readReportDTO.postNo}' style="color:black">
		<!-- http://localhost:8090/GoroGoroCommunity/         board/read?postNo=185 -->
	...
	<c:choose>
		...
		<div class="form-group" style="margin-bottom:30px;">
			<div class="text-right">
				...
				<button type="button" class="btn btn-secondary btn-sm" onclick="javascript:deleteReportDTO();">신고철회</button>
				&emsp;
			</div>
		</div>
