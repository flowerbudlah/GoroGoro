			...
			<table class="table table-hover" id='board_list'>
				...
				<c:forEach var="postDTO" items="${postList }" >
					<tr>
						...
						<td><a href='read?postNo=${postDTO.postNo}' style="color:black">${postDTO.title }</a></td>
...
<div class="d-none d-md-block">
	<ul class="pagination justify-content-center">
		<c:choose>
			...
			<c:otherwise>
				<li class="page-item">
					<a href="${root }main?boardNo=${boardNo}&page=${pageDTO.prePage}" class="page-link">
						이전
					</a>
				</li>
			</c:otherwise>  
		...
		<c:choose>
			<c:when test="${idx == pageDTO.currentPage }">
				<li class="page-item active">
					<a href="${root }main?boardNo=${boardNo}&page=${idx}" class="page-link">
						${idx}
					</a>
				</li>
			</c:when>
			<c:otherwise>
				<li class="page-item">
					<a href="main?boardNo=${boardNo}&page=${idx}" class="page-link">
						${idx}
					</a>
				</li>
			</c:otherwise>
		...
		<c:otherwise>
			<li class="page-item"><a href="${root }main?boardNo=${boardNo}&page=${pageDTO.nextPage}" class="page-link">다음</a></li>
		</c:otherwise>
		</c:choose>
	</ul>
</div>
